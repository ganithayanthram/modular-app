...
import com.ganithyanthram.modularapp.db.jooq.tables.UserProfiles.UserProfilesPath;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>user_profiles</code>
     * table
     */
    public UserProfilesPath userProfiles() {
        if (_userProfiles == null)
            _userProfiles = new UserProfilesPath(this, null, Keys.USER_PROFILES__FK_USER_PROFILES_USER_ID.getInverseKey());
